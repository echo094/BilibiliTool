...
bool CStrConvert::UTF8ToUTF16(const std::string &in, std::wstring &out) {
...
std::wstring toollib::CStrConvert::UTF8ToUTF16(const std::string & in) {
	std::wstring out;
	UTF8ToUTF16(in, out);
	return out;
}

bool CStrConvert::UTF16ToUTF8(const std::wstring &in, std::string &out) {
	using namespace rapidjson;
